const translations = {
  ...
  canvas: {
    ...
    presetScenarios: {
      ...
      generateXHS: 'Generate Xiaohongshu Card',
      generateXHSDesc: 'Create Xiaohongshu content card',
      generateXHSQuery: 'Please create a Xiaohongshu content card about [topic]',
