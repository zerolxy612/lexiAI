const translations = {
  ...
  resource: {
    ...
    import: {
      ...
      fromAudio: 'Upload Audio',
      emptyAudio: 'Please select at least one audio file',
      audioCount: 'Audio files: {{count}}',
      supportedAudio: 'Supported audio formats: {{formats}}',
    },
    wait_parse: 'Parsing',
  ...
  transcription: {
    ...
    processing: 'Transcribing {{filename}}...',
    ...
    copyText: 'Copy Text',
    editText: 'Edit Text',
    editPlaceholder: 'Edit transcription text here...',
    noContent: 'No transcription content',
    enableTranscription: 'Enable Speech-to-Text',
    disableTranscription: 'Disable Speech-to-Text',
    transcriptionHint: 'Audio files will be automatically transcribed after upload',
    retryTranscription: 'Retry Transcription',
    skipTranscription: 'Skip Transcription',
