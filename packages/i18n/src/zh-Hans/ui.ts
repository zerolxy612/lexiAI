const translations = {
  ...
  components: {
    ...
    nodeBlock: {
      ...
      confirmDeleteContent: '确定要删除节点吗？此操作不可恢复。',
      deleteNode: '删除节点',
      wideModeView: '宽屏模式查看',
  ...
  pages: {
    ...
    new: {
      ...
      createPage: '创建页面',
      instructions: '使用说明',
      instructionStep1: '输入Canvas ID并点击"加载节点"按钮',
      ...
      noNodesFound: 'Canvas中没有找到节点数据',
      invalidApiResponse: 'API响应格式不符合预期',
      fetchCanvasDataFailed: '获取Canvas数据失败',
      pleaseEnterCanvasId: '请输入Canvas ID',
      pleaseSelectAtLeastOneNode: '请至少选择一个节点',
      untitledPage: '未命名页面',
      createdFromCanvas: '从Canvas {canvasId}创建',
