const translations = {
  ...
  resource: {
    ...
    import: {
      ...
      fromAudio: '上传音频',
      emptyAudio: '请至少选择一个音频文件',
      audioCount: '音频文件数量：{{count}}',
      supportedAudio: '支持的音频格式：{{formats}}',
    },
    wait_parse: '内容解析中',
    parse_failed: '解析失败',
    wait_index: '模型记忆中',
  ...
  transcription: {
    ...
    copyText: '复制文本',
    editText: '编辑文本',
    editPlaceholder: '在此编辑转录文本...',
    noContent: '暂无转录内容',
    enableTranscription: '启用语音转文字',
    disableTranscription: '禁用语音转文字',
    transcriptionHint: '上传音频文件后将自动进行语音转文字',
    retryTranscription: '重试转录',
    skipTranscription: '跳过转录',
