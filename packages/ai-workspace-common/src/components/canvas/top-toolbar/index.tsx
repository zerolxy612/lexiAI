...
export const TopToolbar: FC<TopToolbarProps> = memo(({ canvasId }) => {
  ...
  return (
    <>
      ...
      {/* Fixed position language switcher and user menu - always top-right */}
      {!isShareCanvas && !isPreviewCanvas && (
        <div className="fixed top-4 right-4 z-20 flex items-center gap-3 bg-white px-3 py-2 rounded-lg shadow-sm border border-gray-200">
          {/* Language switcher */}
          <UILocaleList>
            <Button
              type="text"
