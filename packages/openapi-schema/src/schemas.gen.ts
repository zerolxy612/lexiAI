...
export const PageNodeRelationSchema = {
  type: 'object',
  required: ['relationId', 'pageId', 'nodeId', 'nodeType'],
  properties: {
    relationId: {
      type: 'string',
...
export const CreatePageRequestSchema = {
  ...
  properties: {
    ...
    content: {
      type: 'object',
      description: 'Page initial content',
    },
    coverData: {
      type: 'string',
  ...
  allOf: [
    ...
    },
    {
      ...
      properties: {
        data: {
          type: 'object',
          required: ['pages', 'total', 'page', 'pageSize'],
          properties: {
            pages: {
              type: 'array',
...
export const PublishPageResponseSchema = {
  allOf: [
    {
      $ref: '#/components/schemas/BaseResponse',
    },
      ...
      properties: {
        data: {
          ...
          properties: {
            ...
            versionId: {
              type: 'string',
              description: 'Published version ID',
            },
          },
        },
      },
...
export const PageVersionResponseSchema = {
  allOf: [
    {
      $ref: '#/components/schemas/BaseResponse',
    },
...
export const PageVersionsResponseSchema = {
  allOf: [
    {
      $ref: '#/components/schemas/BaseResponse',
    },
    {
      ...
      properties: {
        data: {
          type: 'array',
          description: 'Page versions list',
          items: {
