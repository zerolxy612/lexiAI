...
export type CreatePageResponse = BaseResponse & {
  /**
   * Created page
   */
  data?: Page;
...
export type PublishPageResponse = BaseResponse & {
  data?: {
    /**
     * Page ID
     */
...
export type PageVersionResponse = BaseResponse & {
  /**
   * Page version detail
   */
  data?: PageDetail;
...
export type PageVersionsResponse = BaseResponse & {
  /**
   * Page versions list
   */
  data?: Array<PageVersion>;
};
...
export type CreatePageResponse2 = CreatePageResponse;
...
export type PublishPageResponse2 = PublishPageResponse;
...
export type GetPageVersionsData = {
  path: {
    /**
     * Page ID
     */
...
export type GetPageVersionsResponse = PageVersionsResponse;

export type GetPageVersionsError = unknown;
...
export type GetPageVersionResponse = PageVersionResponse;

export type GetPageVersionError = unknown;
